                ...
                <div className="bg-white rounded-[3rem] p-8 lg:p-12 overflow-hidden border border-slate-200 shadow-sm">
                    <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                        ...
                        <div className="lg:pl-8">
                            <div className="mb-8">
                                <span className="text-brand-primary font-semibold tracking-tight text-lg font-heading">Fintech Startup</span>
                            </div>
                            <blockquote className="text-xl text-slate-600 leading-relaxed font-light mb-10 font-body">
                                "Chromapages redesigned our core marketing site. The new build is blazing fast, and our conversion rate on paid traffic increased by 45% within the first month of launch."
                            </blockquote>
                            <Link href="/work" className="inline-block px-6 py-2.5 rounded-full bg-brand-secondary text-white text-sm font-medium hover:bg-brand-primary transition-all mb-16">
                                View case study
                            </Link>
                            <div>
                                <p className="text-sm font-semibold text-brand-ink font-heading">Sarah Jenkins</p>
                                <p className="text-sm text-slate-500/70 font-body">CMO, FinanceFlow</p>
                            </div>
                        </div>
